...
return [
   ...
   'vendors' => [
    ...
    'topbar_messages' => [
        'heading' => 'Mensajes Barra Superior',
        'id' => 'ID',
        'title' => 'Título',
        'message' => 'Mensaje',
        'priority' => 'Prioridad',
        ...
        'created' => '¡Mensaje creado con éxito!',
        'updated' => '¡Mensaje actualizado con éxito!',
        'deleted' => '¡Mensaje eliminado con éxito!',
        'status_updated' => '¡Estado del mensaje actualizado con éxito!',
        ...
        'massage_delete' => 'Eliminar',
        'success' => 'Éxito',
        'editor_help' => 'Puedes usar el editor para links, negrilla, etc.',
        'edit' => 'Editar Mensaje Barra Superior',
        'update' => 'Actualizar',
        'back' => 'Volver',
    ],

{{-- Persona informal --}}
<div class="modal fade" id="termsModalInformal" tabindex="-1"
     aria-labelledby="termsModalInformalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>
                    El presente documento regula las condiciones bajo las cuales la persona natural
                    <strong class="tc-person-name">[Nombre completo]</strong>,
                    identificada con número de documento
                ...
                <p>
                    El vendedor informal únicamente podrá ofrecer productos hechos en Colombia, de elaboración propia
                    o artesanal. No está permitida la reventa masiva, la comercialización de productos importados ni la
                    venta de productos prohibidos o regulados por la legislación colombiana.
                </p>
                ...
                <p>
                    Con el fin de mantener el carácter no habitual de la actividad comercial, el vendedor informal acepta
                    que su operación dentro de la plataforma estará sujeta a los siguientes límites:
                </p>

                <ul>
                    <li>Un máximo de veinte (20) pedidos mensuales.</li>
                    <li>Un tope de ingresos de hasta dos (2) Salarios Mínimos Mensuales Legales Vigentes (SMMLV).</li>
                </ul>
                ...
                <p>
                    La negativa a cumplir con este requerimiento podrá dar lugar a la limitación, suspensión o cancelación
                    de la cuenta.
                </p>

                <p>
                    El vendedor informal reconoce que es el único responsable de cumplir con las obligaciones legales,
                    fiscales y tributarias que le sean aplicables conforme a la normativa colombiana.
                </p>
                ...
                <p>
                    Toda responsabilidad derivada de la venta recae exclusivamente en el vendedor.
                </p>
